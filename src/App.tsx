...
const App: React.FC<WithTranslation> = ({ t, i18n }) => {
  ...
  return (
    <div className="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8 bg-gray-900">
      ...
      <button
        type="button"
        className="mx-auto mt-8 flex items-center px-2.5 py-1.5 border border-transparent text-xs font-medium rounded text-indigo-300 bg-indigo-900 hover:bg-indigo-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 select-none"
